...
@Component({
  selector: 'app-pxzs',
  templateUrl: './pxzs.component.html',
  styleUrls: ['./pxzs.component.less',
    '../../default.component.less']
})
export class PxzsComponent implements OnInit {
  ...
  public pageSize = 6;
  public total = 1;
  public listOfData: PeiXunZhengShu[] = Array<PeiXunZhengShu>();
  ...
  searchData(reset: boolean = false) {
    ...
    this.jiuguanzhongxin.getPeiXunZhengShu(this.personId, this.pageIndex, this.pageSize)
      .subscribe(res => {
        console.log(res);
        this.loading = false;
