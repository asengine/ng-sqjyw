...
@Component({
  selector: 'app-sydj',
  templateUrl: './sydj.component.html',
  styleUrls: ['./sydj.component.less',
    '../../default.component.less']
})
export class SydjComponent implements OnInit {
  ...
  public pageSize = 6;
  public total = 1;
  public data: Shiyedengji = new Shiyedengji();
  ...
  searchData(reset: boolean = false) {
    ...
    this.jiuguanzhongxin.getShiyedengji(this.personId, '', '', '')
      .subscribe(res => {
        console.log(res);
        this.loading = false;
