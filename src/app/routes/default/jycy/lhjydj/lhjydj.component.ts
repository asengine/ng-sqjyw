...
@Component({
  selector: 'app-lhjydj',
  templateUrl: './lhjydj.component.html',
  styleUrls: ['./lhjydj.component.less',
    '../../default.component.less']
})
export class LhjydjComponent implements OnInit {
  ...
  public pageSize = 6;
  public total = 1;
  public data: Linghuojiuyedengji = new Linghuojiuyedengji();
  ...
  searchData(reset: boolean = false) {
    ...
    this.jiuguanzhongxin.getLinghuojiuyedengji(this.personId, '', '', '')
      .subscribe(res => {
        console.log(res);
        this.loading = false;
