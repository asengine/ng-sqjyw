...
@Component({
  selector: 'app-xwqydbdk',
  templateUrl: './xwqydbdk.component.html',
  styleUrls: ['./xwqydbdk.component.less',
    '../../default.component.less']
})
export class XwqydbdkComponent implements OnInit {
  ...
  /**身份证号码 */
  public cardno = '';
  public title = '小微企业担保贷款';
  /// 分页参数
  public pageIndex = 1;
  public pageSize = 6;
  public total = 1;
  public data: Xiaoweiqiyedanbaodaikuan = new Xiaoweiqiyedanbaodaikuan();
  ...
  searchData(reset?: boolean) {
    ...
    this.jiuguanzhongxin.getXiaoweiqiyedanbaodaikuan(this.bab001, '', '')
      .subscribe(res => {
        console.log(res);
        this.loading = false;
