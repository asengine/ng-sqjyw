...
@Component({
  selector: 'app-pxbm',
  templateUrl: './pxbm.component.html',
  styleUrls: ['./pxbm.component.less',
    '../../default.component.less']
})
export class PxbmComponent implements OnInit {
  ...
  public pageSize = 6;
  public total = 1;
  public listOfData: PeiXunBaoMing[] = Array<PeiXunBaoMing>();
  ...
  searchData(reset: boolean = false) {
    ...
    this.jiuguanzhongxin.getPeiXunBaoMing(this.personId, this.pageIndex, this.pageSize)
      .subscribe(res => {
        console.log(res);
        this.loading = false;
