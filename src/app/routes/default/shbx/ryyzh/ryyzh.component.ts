...
@Component({
  selector: 'app-ryyzh',
  templateUrl: './ryyzh.component.html',
  styleUrls: ['./ryyzh.component.less',
    '../../default.component.less']
})
export class RyyzhComponent implements OnInit {
  ...
  /**身份证号码 */
  public cardno = '';
  public title = '人员月账户信息';
  /// 分页参数
  public pageIndex = 1;
  public pageSize = 6;
  public total = 1;
  public listOfData: Renyuanyuezhanghu[] = Array<Renyuanyuezhanghu>();
  ...
  searchData(reset?: boolean) {
    ...
    this.shehuibaoxian.getRenyuanyuezhanghu(this.personId, this.pageIndex, this.pageSize)
      .subscribe(res => {
        console.log(res);
        this.loading = false;
