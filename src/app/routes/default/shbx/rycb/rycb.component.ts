...
@Component({
  selector: 'app-rycb',
  templateUrl: './rycb.component.html',
  styleUrls: [
    './rycb.component.less',
    '../../default.component.less'
  ]
})
export class RycbComponent implements OnInit {
  ...
  searchData(reset: boolean = false) {
    ...
    this.shehuibaoxian.getRenyuancanbao(this.personId, this.pageIndex, this.pageSize)
      .subscribe(res => {
        console.log(res);
        this.loading = false;
