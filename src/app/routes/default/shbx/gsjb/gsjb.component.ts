...
@Component({
  selector: 'app-gsjb',
  templateUrl: './gsjb.component.html',
  styleUrls: ['./gsjb.component.less',
    '../../default.component.less']
})
export class GsjbComponent implements OnInit {
  ...
  public pageSize = 6;
  public total = 1;
  public listOfData: Gongshangjiben[] = Array<Gongshangjiben>();
  ...
  searchData(reset: boolean = false) {
    ...
    this.shehuidaiyu.getGongshangjiben(this.personId, this.pageIndex, this.pageSize)
      .subscribe(res => {
        console.log(res);
        this.loading = false;
