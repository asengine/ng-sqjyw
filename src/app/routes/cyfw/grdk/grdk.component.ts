...
import { GrdkdetailsComponent } from './grdkdetails/grdkdetails.component';

@Component({
  selector: 'app-grdk',
  templateUrl: './grdk.component.html',
  styleUrls: ['./grdk.component.less']
})
export class GrdkComponent implements OnInit {
